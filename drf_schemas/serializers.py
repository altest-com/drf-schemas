...
class DateTimeFieldSerializer(FieldSerializer):
    ...
    data_type = serializers.ChoiceField(
        choices=models.DateTimeField.TYPE_CHOICES,
        required=False,
        help_text='Date time type'
    )
...
class NumberFieldSerializer(FieldSerializer):
    ...
    display_as = serializers.ChoiceField(
        required=False,
        choices=models.NumberField.DISPLAY_CHOICES,
        default=models.NumberField.DISPLAY_INPUT,
        help_text='Type of control to display to the user. Can be one of '
                  '"input" or "slider"'
    )
    prefix = serializers.CharField(
        required=False,
        allow_blank=True,
        help_text='Prefix to append to field when it is shown to user'
    )
    suffix = serializers.CharField(
        required=False,
        allow_blank=True,
        help_text='Suffix to append to field when it is shown to user'
    )
    integer = serializers.BooleanField(
        required=False,
        help_text='Weather it is a integer value'
    )
...
class BooleanFieldSerializer(FieldSerializer):
    ...
    display_as = serializers.ChoiceField(
        required=False,
        choices=models.BooleanField.DISPLAY_CHOICES,
        default=models.BooleanField.DISPLAY_SWITCH,
        help_text='Type of control to display to the user. Can be one of '
                  '"switch", "buttons" or "radio"'
    )
...
class ChoicesFieldSerializer(FieldSerializer):
    ...
    display_as = serializers.ChoiceField(
        required=False,
        choices=models.ChoicesField.DISPLAY_CHOICES,
        default=models.ChoicesField.DISPLAY_SELECT,
        help_text='Type of control to display to the user. Can be one of '
                  '"select", "buttons" or "check"'
    )
